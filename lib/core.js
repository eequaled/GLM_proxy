// Shared core machinery for the AutoClaw gateway proxies.
// Extracted from main.js (OpenAI format) and anthropic.js (Anthropic format)
// so both entrypoints import the same loader/logger/HTTP helpers.
...
export function loadConfig({ defaultPort }) {
  ...
  return {
    ...
    UPSTREAM_BASE, UPSTREAM_URL, TOKEN_FILE, TOKEN_TTL_MS,
